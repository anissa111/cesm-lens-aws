...
export const HomeObjDataAccess = {
  ...
  description:
    '<ul><li>S3 bucket: ncar-cesm-lens in us-west-2 region</li><li>Amazon Resource Name arn:aws:s3:::ncar-cesm-lens</li><li>Bucket contents list: <a href="https://ncar-cesm-lens.s3.amazonaws.com/">https://ncar-cesm-lens.s3.amazonaws.com/</a></li></ul><br><p>The intent is for users to compute directly on the data in AWS rather than downloading from S3 (traditional download is available from the NCAR CDG link above).</p>',
  buttonLabel: '',
  imgStart: true,
  img: data,
  alt: 'data-access',
